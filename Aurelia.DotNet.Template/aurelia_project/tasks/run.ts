...
function runWebpack(done) {
  ...
  let opts = {
    ...
    hot: $safeprojectname$.platform.hmr || CLIOptions.hasFlag('hmr'),
    port: $safeprojectname$.platform.port,
    contentBase: config.output.path,
    historyApiFallback: true,
    open: $safeprojectname$.platform.open,
    stats: {
  ...
  if ($safeprojectname$.platform.hmr || CLIOptions.hasFlag('hmr')) {
